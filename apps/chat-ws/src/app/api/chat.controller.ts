...
import { Authorities, ChatRoomListResponse, Roles } from '@eco-books/type-common';
...
export class ChatController {
  ...
  @Get('list')
  @Roles(Authorities.USER)
  getPageChats(@Req() request: Request, @Query('chatId') chatId: string, @Query('size') size: number) {
